...
<div class="container-fluid p-0">
    ...
    <h1 class="h3 mb-3">Technical Services</h1>
                ...
                <table class="all-order-table">
                        <tbody>
                            ...
                            $serviceSql = "select id,
                                    ...
                                    description,
                                    featured,
                                    date from `services` where category_id='3' order by id desc";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actionBtn">
                                                ...
                                                <form method="post" action="<?= ADMIN_LINK; ?>controllers/deleteServiceController.php?action=technical">
