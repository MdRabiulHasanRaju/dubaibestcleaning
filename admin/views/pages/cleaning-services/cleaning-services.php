...
<div class="container-fluid p-0">
    ...
    <h1 class="h3 mb-3">Cleaning Services</h1>
                ...
                <table class="all-order-table">
                        <tbody>
                            ...
                            $serviceSql = "select id,
                                    ...
                                    description,
                                    featured,
                                    date from `services` where category_id='2' order by id desc";
